...
class GoImages {
    ...
    public Bitmap[] _whites;
    public Bitmap[] _whitesAlpha;
    private int _stoneSize;
    //--------------------------------------------//
    public GoImages() {
        _whites = new Bitmap[D_WHITE_LOOKS];
        _whitesAlpha = new Bitmap[D_WHITE_LOOKS];
    }
    ...
    private Bitmap background( int $size ) {
        ...
        return ( Bitmap.createBitmap(buf, D_WIDTH, D_HEIGHT, Bitmap.Config.ARGB_8888) );
    }
    ...
    private Bitmap white( int $size, boolean $alpha ) {
        final int D_WIDTH = $size;
        final int D_HEIGHT = $size;
        ...
        return ( Bitmap.createBitmap(pw, D_WIDTH, D_HEIGHT, Bitmap.Config.ARGB_8888) );
    }

    private Bitmap black( int $size, boolean $alpha ) {
        final int D_WIDTH = $size;
        final int D_HEIGHT = $size;
        final double pixel = 0.8;
        ...
        return ( Bitmap.createBitmap(pb, D_WIDTH, D_HEIGHT, Bitmap.Config.ARGB_8888) );
    }

    Bitmap shadow( int $size ) {
        final int D_WIDTH = $size;
        final int D_HEIGHT = $size;
